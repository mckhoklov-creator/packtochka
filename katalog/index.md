---
layout: default
title: "Каталог упаковочных материалов — коробки, плёнка, БОПП пакеты | ПакТочка Екатеринбург"
description: "Каталог упаковочных материалов ПакТочка: коробки, пакеты, скотч, стрейч-плёнка, пупырчатая плёнка, гофрорулоны, БОПП пакеты, этикетки и крафтовая бумага. Купить упаковку оптом и в розницу в Екатеринбурге с доставкой по всей России."
permalink: /katalog/
---
...
<nav class="cat-links">
  {% for cat in site.data.catalog_categories %}
    <a href="{{ cat.url | relative_url }}">{{ cat.title }}</a>
  {% endfor %}
</nav>
